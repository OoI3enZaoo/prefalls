				...
				<nav class="navbar navbar-default navbar-static-top">
					<div class="container-fluid">
						<div class="navbar-header">
							...
							<a class="header-brand" href="./listname/">
								<img src="images/logo.png"></a>
							</div>
							<div id="navbar" class="navbar-collapse collapse">
								<ul class="nav navbar-nav">
									<li class="active">
										<a href="activity.jsp">กิจกรรมประจำวัน</a>
									</li>
									<li>
										<a href="./history/">ประวัติกิจกรรม</a>
									</li>
									<li>
										<a href="./notifications/">บันทึกการแจ้งเตือน</a>
									</li>
									<li>
										<a href="mobility.jsp">บันทึกผลการทดสอบ</a>
									</li>
									<li>
										<a href="./profile/">ข้อมูลส่วนตัว</a>
									</li>
									<li class="end">
										<a href="setting.jsp">ตั้งค่า</a>
									</li>
								</ul>
					...
					<div class="container">
						<div class="container-header line">
							<font class="s17">กิจกรรมประจำวัน</font>
						</div>
						...
						<div class="col-md-6 col-xs-12">
							<div class="connn">
								...
								<div class="asd">
									<img src="images/icons/hr.png" width="30" height="30">&nbsp;Avg heart rate&nbsp;:&nbsp;<font id="hr"><%out.print(avghr/count);%></font>&nbsp;bpm</div>
									<div class="asd">
										<img src="images/icons/step.png" width="30" height="30">&nbsp;Steps&nbsp;:&nbsp;<font id="steps"><%=step%></font>
										</div>
										<div class="asd">
											<img src="images/icons/cal.png" width="30" height="30">&nbsp;Cal burn&nbsp;:&nbsp;<font id="cal"><%out.print((sit*1.6)+(stand*2.3)+(walk*5)+(as*14.1)+(run*11.6)+(cycling*10));%></font>
											</div>
											<div class="asd">
												<img src="images/icons/stattime.png" width="30" height="30">&nbsp;Stationary time&nbsp;:&nbsp;<font id="stationary"><%out.print(sit+stand);%></font>
												</div>
												<div class="asd">
													<img src="images/icons/active.png" width="30" height="30">&nbsp;Active time&nbsp;:&nbsp;<font id="active"><%out.print(walk+as);%></font>
													</div>
													<div class="asd">
														<img src="images/icons/highlyactive.png" width="30" height="30">&nbsp;Highlyactive time&nbsp;:&nbsp;<font id="highlyactive"><%out.print(run+cycling);%></font>
														</div>
