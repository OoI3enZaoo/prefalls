   ...
   <div class="col-xs-12 col-md-9">
      ...
      <div class="col-md-6">
         <div class="input-group">
            ...
            <input type="text" class="form-control" value="<%=fn%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
      <div class="col-md-6">
         <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Surname</span>
            <input type="text" class="form-control" value="<%=ln%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
      <div class="col-md-6">
         <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Sex</span>
            <input type="text" class="form-control" value="<%=sex%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
      <div class="col-md-6">
         <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Birthday</span>
            <input type="text" class="form-control" value="<%=bd%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
      <div class="col-md-12">
         <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Address</span>
            <input type="text" class="form-control" value="<%=ad%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
      ...
      <div class="col-md-6">
         <div class="input-group">
            ...
            <input type="text" class="form-control" value="<%=wg%>" aria-describedby="basic-addon1" readonly>
      ...
      <div class="col-md-6">
         <div class="input-group">
            ...
            <input type="text" class="form-control" value="<%=hg%>" aria-describedby="basic-addon1" readonly>
      ...
      <div class="col-md-6">
         <div class="input-group">
            ...
            <input type="text" class="form-control" value="<%=dis%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
      <div class="col-md-6">
         <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Medication</span>
            <input type="text" class="form-control" value="<%=med%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
      <div class="col-md-6">
         <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Drug allergies</span>
            <input type="text" class="form-control" value="<%=agmed%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
      <div class="col-md-6">
         <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Food allergies</span>
            <input type="text" class="form-control" value="<%=agfood%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
      <div class="col-md-6">
         <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Birthmarks</span>
            <input type="text" class="form-control" value="<%=app%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
      <div class="col-md-6">
         <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Hospital</span>
            <input type="text" class="form-control" value="<%=hn%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
      ...
      <div class="col-md-12">
         <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Name</span>
            <input type="text" class="form-control" value="<%=cn1%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
      <div class="col-md-6">
         <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Telephone number</span>
            <input type="text" class="form-control" value="<%=cp1%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
      <div class="col-md-6">
         <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Relationship</span>
            <input type="text" class="form-control" value="<%=cr1%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
      <div class="col-md-12">
         <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Name</span>
            <input type="text" class="form-control" value="<%=cn2%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
      <div class="col-md-6">
         <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Telephone number</span>
            <input type="text" class="form-control" value="<%=cp2%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
      <div class="col-md-6">
         <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Relationship</span>
            <input type="text" class="form-control" value="<%=cr2%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
      <div class="col-md-12">
         <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Name</span>
            <input type="text" class="form-control" value="<%=cn3%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
      <div class="col-md-6">
         <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Telephone number</span>
            <input type="text" class="form-control" value="<%=cp3%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
      <div class="col-md-6">
         <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Relationship</span>
            <input type="text" class="form-control" value="<%=cr3%>" aria-describedby="basic-addon1" readonly>
         </div></br>
      </div>
   </div>
</div>
