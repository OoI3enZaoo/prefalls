...
<div class="container">
   ...
   <form action="insert.jsp" method="post">
      ...
      <div class="container-header col-md-12"><font class="fs17">ข้อมูลทั่วไป</font></div></br>
      <div class="col-md-6">
      ...
      <div class="container-header col-md-12"><font class="fs17">ข้อมูลด้านสุขภาพ</font></div>
      <div class="col-md-6">
         <div class="input-group">
      ...
      <div class="container-header col-md-12"><font class="fs17">ข้อมูลการติดต่อ</font></div>
      <div class="col-md-12">
         <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">ชื่อ</span>
