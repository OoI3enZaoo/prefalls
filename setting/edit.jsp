...
<%
    ...
    String name = name = " Patient Name : " + session.getAttribute("fname") + " " + (String)session.getAttribute("lname") + " ";
    String minHR = "";
    String maxHR = "";
    String maxS = "";
    String editsetting ="";
	...
	if(sstypeid.equals("1")||sstypeid.equals("2")){
		...
		try {
			...
			if(rs.next()){				
				rs.first();
                editsetting = editsetting + "<a href='edit.jsp'><button type='button' class='btn btn-warning glyphicon glyphicon-edit' onClick=edit.jsp>แก้ไข</button></a>";
			}
...
<div class="container">
    ...
    <div class="panel" style="margin-left:10px;margin-right:10px;">
        ...
        <a href="../setting/"><button type="button" class="btn btn-danger glyphicon glyphicon-remove">Cancel</button></a>
        ...
        <div class="input-group" style="width:300px;">
            ...
            <input type="text" name="maxHR" class="form-control" value="<%=maxHR%>" aria-describedby="basic-addon1">
        </div><br>
        <div class="input-group" style="width:300px;">
            <span class="input-group-addon" id="basic-addon1">Minimum heart rate (bpm)</span>
            <input type="text" name="minHR" class="form-control" value="<%=minHR%>" aria-describedby="basic-addon1">
        </div><br>
        <div class="input-group" style="width:300px;">
            <span class="input-group-addon" id="basic-addon1">Maximum immobility time (Minutes)</span>
            <input type="text" name="maxS" class="form-control" value="<%=maxS%>" aria-describedby="basic-addon1">
        </div>
        </form>
    </div>    
</div>
